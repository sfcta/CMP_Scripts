...
CORR_FILE = 'CMP_Segment_INRIX_Links_Correspondence_2101_Manual_PLUS_ExpandedNetwork.csv'

GEO_DIR = r'Q:\GIS\Transportation\Roads\INRIX\XD\22_01'
...
shp_df = gpd.read_file(join(GEO_DIR, 'maprelease-shapefiles', 'SF', 'Inrix_XD_2201_SF.shp'))

old_shp_df = gpd.read_file(r'Q:\GIS\Transportation\Roads\INRIX\XD\21_02\maprelease-shapefiles\SF\Inrix_XD_2102_SF.shp')
...
print(xd_add)
# looks like 548 new segments were added
