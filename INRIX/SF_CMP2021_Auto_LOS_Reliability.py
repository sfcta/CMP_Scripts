...
def cmp_seg_level_speed_and_los(df_cmp_period, ss_threshold, floating_car_spds, cur_year, cur_period):
    ...
    cmp_period_combine = cmp_period_agg.append(cmp_period_frc[['cmp_segid', 'year', 'source', 'period', 'avg_speed', 'std_speed', 'sample_size']], ignore_index=True)
    ...
    cmp_period_combine = cmp_period_combine[['cmp_segid', 'year', 'source', 'period', 'avg_speed', 'los_hcm85', 'los_hcm00', 'std_speed', 'pcnt5th', 'pcnt20th', 'cov', 'sample_size', 'comment']]
    
    return cmp_period_combine
    

cmp_am_agg = cmp_seg_level_speed_and_los(df_cmp_am, ss_threshold, fcr_avg_spds, cur_year = 2021, cur_period = 'AM')
cmp_pm_agg = cmp_seg_level_speed_and_los(df_cmp_pm, ss_threshold, fcr_avg_spds, cur_year = 2021, cur_period = 'PM')
