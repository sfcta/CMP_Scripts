...
DATA_DIR = r'Q:\Data\Observed\Streets\INRIX\v2201'
...
INPUT_PATHS = [['All_SF_2022-09-04_to_2022-09-11_1_min_part_', 4]]
...
cmp_segs=gp.read_file(os.path.join(r'Q:\CMP\LOS Monitoring 2022\CMP_exp_shp', 'cmp_segments_exp_v2201.shp'))
