...
def download_links(link_list, dt, out_path, url_base='https://pems.dot.ca.gov/'):
    """
        ...
        for i,link in enumerate(link_list):
            ...
            while True:
                try: # Download with 10-second sleep time breaks
                    ...
                    if not os.path.exists(os.path.split(out_path+fname)[0]):
                        os.mkdir(os.path.split(out_path+fname)[0])
