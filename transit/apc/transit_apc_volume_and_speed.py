...
OUT_DIR = r'Q:\CMP\LOS Monitoring 2021\Transit\Speed\2022\06_Jun'
YEAR = 2022
SEG_EXEMPT = [237,245]
...
overlap_pairs = pd.read_csv(os.path.join(APC_DIR, 'Postprocessing_overlapping_transit_segments_2022.csv'))
...
vol_sum = apc_notnull.groupby(['BS_ID', 'Date', 'Epoch']).agg({'ONS': 'sum', 'OFFS': 'sum', 'MAX_LOAD': 'sum', 'Close_Time':'count'}).reset_index()
