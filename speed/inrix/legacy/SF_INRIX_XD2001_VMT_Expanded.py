...
CORR_FILE = 'CMP_Segment_INRIX_Links_Correspondence_2001_Manual_PLUS_ExpandedNetwork.csv'

DATA_DIR = r'Q:\Data\Observed\Streets\INRIX\v2001'

OUT_DIR = r'Q:\CMP\LOS Monitoring 2020\VMT'

# OUT_FILE = 'Apr2014_AutoSpeeds.csv'
# INPUT_PATHS = [['All_SF_2014-04-01_to_2014-05-10_1_min_part_', 16]]

# OUT_FILE = 'Apr2015_AutoSpeeds.csv'
# INPUT_PATHS = [['All_SF_2015-04-05_to_2015-05-10_1_min_part_', 14]]

# OUT_FILE = 'Apr2016_AutoSpeeds.csv'
# INPUT_PATHS = [['All_SF_2016-04-03_to_2016-05-08_1_min_part_', 14]]

# OUT_FILE = 'Apr2017_AutoSpeeds.csv'
# INPUT_PATHS = [['All_SF_2017-04-02_to_2017-05-07_1_min_part_', 14]]

# OUT_FILE = 'Apr2018_AutoSpeeds.csv'
# INPUT_PATHS = [['All_SF_2018-04-01_to_2018-05-06_1_min_part_', 14]]

OUT_FILE = 'Apr2019_AutoSpeeds.csv'
INPUT_PATHS = [['All_SF_2019-04-01_to_2019-05-12_1_min_part_', 16]]
