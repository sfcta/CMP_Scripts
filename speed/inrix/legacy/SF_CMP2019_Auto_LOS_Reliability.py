...
OUT_FILE = 'CMP2019_Auto_Speeds_Reliability.csv'
INPUT_PATHS = [['SF_All_v1902_2019-04-01_to_2019-05-17_1_min_part_', 7]]
...
cmp_am_agg = cmp_seg_level_speed_and_los(df_cmp_am, ss_threshold, r_spatial_thrd, cur_year = 2019, cur_period = 'AM')
cmp_pm_agg = cmp_seg_level_speed_and_los(df_cmp_pm, ss_threshold, r_spatial_thrd, cur_year = 2019, cur_period = 'PM')
