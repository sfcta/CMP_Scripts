...
ss_threshold = 30 # from last cycle
...
filename1 = r'Q:\Data\Observed\Streets\NPMRDS\NPMRDS_Expanded_Coverage_SanFran_3-4_2019-3-4_2017_paxtrk\NPMRDS_Expanded_Coverage_SanFran_3-4_2019-3-4_2017.csv'
...
SEL_YEAR = 2017
# df_cmp = df_cmp[(df_cmp['Month']==4) & (df_cmp['Year']==SEL_YEAR)]
df_cmp = df_cmp[df_cmp['Year']==SEL_YEAR]
OUTFILE = r'Q:\CMP\LOS Monitoring 2019\Auto_LOS\NPMRDS %s Auto LOS.csv' %SEL_YEAR

#Get AM (7-9am) speeds on Tue, Wed, and Thu
df_am=df_cmp[((df_cmp['DOW']>=1) & (df_cmp['DOW']<=3)) & ((df_cmp['Hour']==7) | (df_cmp['Hour']==8))]
dd.to_csv(df_am[df_am['tmc_code'].isin(['105+10331'])], r'Q:\CMP\LOS Monitoring 2019\Auto_LOS\am*.csv')
