...
DATA_DIR = r'Q:\Data\Observed\Streets\INRIX\v2102'

OUT_DIR = r'Q:\CMP\Congestion_Tracker\viz_data'

# OUT_FILE = ['Oct2021_AutoSpeeds', '1']
# INPUT_PATHS = [['All_SF_2021-10-03_to_2021-10-10_1_min_part_', 4]]

# OUT_FILE = ['Oct2021_AutoSpeeds', '2']
# INPUT_PATHS = [['All_SF_2021-10-10_to_2021-10-17_1_min_part_', 4]]

# OUT_FILE = ['Oct2021_AutoSpeeds', '3']
# INPUT_PATHS = [['All_SF_2021-10-17_to_2021-10-24_1_min_part_', 4]]

# OUT_FILE = ['Oct2021_AutoSpeeds', '4']
# INPUT_PATHS = [['All_SF_2021-10-24_to_2021-10-31_1_min_part_', 4]]

# OUT_FILE = ['Oct2021_AutoSpeeds', '5']
# INPUT_PATHS = [['All_SF_2021-10-31_to_2021-11-07_1_min_part_', 4]]

# OUT_FILE = ['Nov2021_AutoSpeeds', '1']
# INPUT_PATHS = [['All_SF_2021-11-07_to_2021-11-14_1_min_part_', 4]]

# OUT_FILE = ['Nov2021_AutoSpeeds', '2']
# INPUT_PATHS = [['All_SF_2021-11-14_to_2021-11-21_1_min_part_', 4]]

# OUT_FILE = ['Nov2021_AutoSpeeds', '3']
# INPUT_PATHS = [['All_SF_2021-11-21_to_2021-11-28_1_min_part_', 4]]

# OUT_FILE = ['Nov2021_AutoSpeeds', '4']
# INPUT_PATHS = [['All_SF_2021-11-28_to_2021-12-05_1_min_part_', 4]]

# OUT_FILE = ['Dec2021_AutoSpeeds', '1']
# INPUT_PATHS = [['All_SF_2021-12-05_to_2021-12-12_1_min_part_', 4]]

# OUT_FILE = ['Dec2021_AutoSpeeds', '2']
# INPUT_PATHS = [['All_SF_2021-12-12_to_2021-12-19_1_min_part_', 4]]

# OUT_FILE = ['Dec2021_AutoSpeeds', '3']
# INPUT_PATHS = [['All_SF_2021-12-19_to_2021-12-26_1_min_part_', 4]]

# OUT_FILE = ['Dec2021_AutoSpeeds', '4']
# INPUT_PATHS = [['All_SF_2021-12-26_to_2022-01-02_1_min_part_', 4]]

# OUT_FILE = ['Jan2022_AutoSpeeds', '1']
# INPUT_PATHS = [['All_SF_2022-01-02_to_2022-01-09_1_min_part_', 4]]

# OUT_FILE = ['Jan2022_AutoSpeeds', '2']
# INPUT_PATHS = [['All_SF_2022-01-09_to_2022-01-16_1_min_part_', 4]]

# OUT_FILE = ['Jan2022_AutoSpeeds', '3']
# INPUT_PATHS = [['All_SF_2022-01-16_to_2022-01-23_1_min_part_', 4]]

# OUT_FILE = ['Jan2022_AutoSpeeds', '4']
# INPUT_PATHS = [['All_SF_2022-01-23_to_2022-01-30_1_min_part_', 4]]

# OUT_FILE = ['Feb2022_AutoSpeeds', '1']
# INPUT_PATHS = [['All_SF_2022-01-30_to_2022-02-06_1_min_part_', 4]]

# OUT_FILE = ['Feb2022_AutoSpeeds', '2']
# INPUT_PATHS = [['All_SF_2022-02-06_to_2022-02-13_1_min_part_', 4]]

# OUT_FILE = ['Feb2022_AutoSpeeds', '3']
# INPUT_PATHS = [['All_SF_2022-02-13_to_2022-02-20_1_min_part_', 4]]

# OUT_FILE = ['Feb2022_AutoSpeeds', '4']
# INPUT_PATHS = [['All_SF_2022-02-20_to_2022-02-27_1_min_part_', 4]]

# OUT_FILE = ['Mar2022_AutoSpeeds', '1']
# INPUT_PATHS = [['All_SF_2022-02-27_to_2022-03-06_1_min_part_', 4]]

###################################################################SFMTA data request
# OUT_FILE = ['AutoSpeeds', '2017-02-05_to_2017-02-12']
# INPUT_PATHS = [['All_SF_2017-02-05_to_2017-02-12_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2017-05-07_to_2017-05-14']
# INPUT_PATHS = [['All_SF_2017-05-07_to_2017-05-14_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2017-08-06_to_2017-08-13']
# INPUT_PATHS = [['All_SF_2017-08-06_to_2017-08-13_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2017-11-12_to_2017-11-19']
# INPUT_PATHS = [['All_SF_2017-11-12_to_2017-11-19_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2018-02-04_to_2018-02-11']
# INPUT_PATHS = [['All_SF_2018-02-04_to_2018-02-11_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2018-05-06_to_2018-05-13']
# INPUT_PATHS = [['All_SF_2018-05-06_to_2018-05-13_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2018-08-05_to_2018-08-12']
# INPUT_PATHS = [['All_SF_2018-08-05_to_2018-08-12_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2018-11-04_to_2018-11-11']
# INPUT_PATHS = [['All_SF_2018-11-04_to_2018-11-11_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2019-02-03_to_2019-02-10']
# INPUT_PATHS = [['All_SF_2019-02-03_to_2019-02-10_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2019-05-05_to_2019-05-12']
# INPUT_PATHS = [['All_SF_2019-05-05_to_2019-05-12_1_min_part_', 4]]

# OUT_FILE = ['AutoSpeeds', '2019-08-04_to_2019-08-11']
# INPUT_PATHS = [['All_SF_2019-08-04_to_2019-08-11_1_min_part_', 4]]

OUT_FILE = ['AutoSpeeds', '2019-11-17_to_2019-11-24']
INPUT_PATHS = [['All_SF_2019-11-17_to_2019-11-24_1_min_part_', 4]]
###################################################################SFMTA data request
